...
public class CustomerRegisterOutDto {
    ...
    public CustomerRegisterOutDto(String username, String realname, String mobile, String email, String password, boolean newsSubscribed) {
